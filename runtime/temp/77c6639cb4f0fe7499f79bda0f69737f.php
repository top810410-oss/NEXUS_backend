<?php /*a:1:{s:73:"/home/wwwroot/demo70.zhigou888.com/app/super/view/member/member_list.html";i:1764755762;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div style="margin-top: 10px;">
        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <th width="40">用户语言(英语/中文)</th>
                <th width="40">启/禁翻译</th>
                <th width="40">启/禁抢红包</th>
                <th width="40">启/禁用客服</th>
            ...
            <tr class="text-c">
                ...
                <td><u style="cursor:pointer" class="text-primary"
                       onclick="member_show('<?php echo htmlentities($u['yuan_name']); ?>的信息','<?php echo htmlentities($u['id']); ?>','<?php echo url('/super_memberShow'); ?>','460','400')"><?php echo $u['username']; ?></u>
                </td>
                <td><?php echo $u['nickname']; ?></td>
                <td>
                    <?php switch($u['sex']): case "0": ?>男<?php break; case "1": ?>女<?php break; ?>
                    <?php endswitch; ?>
                </td>
                <td><?php echo $u['money']>=0 ? htmlentities($u['money']) :  0; ?></td>
                <td><?php echo date('Y-m-d H:i:s',$u['create_time']); ?></td>
                <td class="td-status">
                    <?php if($u['status'] == 1): ?>
                    <span class="label label-disabled radius"
                          onclick="changeUserStatus(this,<?php echo htmlentities($u['id']); ?>,'<?php echo htmlentities($u['yuan_name']); ?>',0)" style="cursor: pointer;">禁用</span>
                    <?php else: ?>
                    <span class="label label-success radius" onclick="changeUserStatus(this,<?php echo htmlentities($u['id']); ?>,'<?php echo htmlentities($u['yuan_name']); ?>',1)"
                ...
                <td class="td-language">
                    <?php if($u['language'] == 0): ?>
                    <span class="label label-disabled radius"
                          onclick="changeUserLanguage(this,<?php echo htmlentities($u['id']); ?>,'<?php echo htmlentities($u['yuan_name']); ?>',1)" style="cursor: pointer;">英语</span>
                    <?php else: ?>
                    <span class="label label-success radius" onclick="changeUserLanguage(this,<?php echo htmlentities($u['id']); ?>,'<?php echo htmlentities($u['yuan_name']); ?>',0)"
                          style="cursor: pointer;">中文</span>
                    <?php endif; ?>
                ...
                <td class="td-fanyi">
                    <?php if($u['is_fanyi'] == 0): ?>
                    <span class="label label-disabled radius"
                          onclick="changeUserFanyi(this,<?php echo htmlentities($u['id']); ?>,'<?php echo htmlentities($u['yuan_name']); ?>',1)" style="cursor: pointer;">禁用</span>
                    <?php else: ?>
                    <span class="label label-success radius" onclick="changeUserFanyi(this,<?php echo htmlentities($u['id']); ?>,'<?php echo htmlentities($u['yuan_name']); ?>',0)"
                          style="cursor: pointer;">正常</span>
                    <?php endif; ?>
                ...
                <td class="td-qiang">
                    <?php if($u['is_qiang'] == 0): ?>
                    <span class="label label-disabled radius"
                          onclick="changeUserQiang(this,<?php echo htmlentities($u['id']); ?>,'<?php echo htmlentities($u['yuan_name']); ?>',1)" style="cursor: pointer;">禁用</span>
                    <?php else: ?>
                    <span class="label label-success radius" onclick="changeUserQiang(this,<?php echo htmlentities($u['id']); ?>,'<?php echo htmlentities($u['yuan_name']); ?>',0)"
                          style="cursor: pointer;">正常</span>
                    <?php endif; ?>
                ...
                <td class="td-manage">
                    ...
                    <?php if($u['is_customer_service']): ?>
                    <span class="label label-success radius"
                          onclick="changeUserService(this,<?php echo htmlentities($u['id']); ?>,'<?php echo htmlentities($u['yuan_name']); ?>',0,<?php echo htmlentities($u['agent_id']); ?>)"
                          style="cursor: pointer;">禁用客服</span>
                    <?php else: ?>
                    <span class="label label-disabled  radius"
                          onclick="changeUserService(this,<?php echo htmlentities($u['id']); ?>,'<?php echo htmlentities($u['yuan_name']); ?>',1,<?php echo htmlentities($u['agent_id']); ?>)"
                          style="cursor: pointer;">启用客服</span>
                    <?php endif; ?>
                ...
                <!--<td class="td-manage">-->
                    <!--<?php if($u['is_robot']): ?>-->
                    <!--<span class="label label-success radius"-->
                          <!--onclick="changeUserRobot(this,<?php echo htmlentities($u['id']); ?>,'<?php echo htmlentities($u['yuan_name']); ?>',0,<?php echo htmlentities($u['agent_id']); ?>)"-->
                          <!--style="cursor: pointer;">禁用机器人</span>-->
                    <!--<?php else: ?>-->
                    <!--<span class="label label-disabled  radius"-->
                          <!--onclick="changeUserRobot(this,<?php echo htmlentities($u['id']); ?>,'<?php echo htmlentities($u['yuan_name']); ?>',1,<?php echo htmlentities($u['agent_id']); ?>)"-->
                          <!--style="cursor: pointer;">启用机器人</span>-->
                    <!--<?php endif; ?>-->
                <!--</td>-->
                <td>
                    <button class="btn radius btn-primary size-S"
                            onclick="member_showChat('<?php echo htmlentities($u['yuan_name']); ?>的会话','<?php echo htmlentities($u['id']); ?>','<?php echo url('/super_MemberChatList'); ?>','760','580')">
                        查看会话
                    </button>
                    <button class="btn radius btn-primary size-S"
                            onclick="member_showMail('<?php echo htmlentities($u['yuan_name']); ?>的通讯录','<?php echo htmlentities($u['id']); ?>','<?php echo url('/super_MemberMailList'); ?>','760','580')">
                        查看通讯录
                    </button>
                    <button class="btn radius btn-primary size-S"
                            onclick="member_showMail('重置<?php echo htmlentities($u['yuan_name']); ?>的密码','<?php echo htmlentities($u['id']); ?>','<?php echo url('/super_updateUserPassword'); ?>','760','580')">
                        重置密码
                    </button>
                    <button class="btn radius btn-primary size-S"
                            onclick="member_showMail('重置<?php echo htmlentities($u['yuan_name']); ?>的交易密码','<?php echo htmlentities($u['id']); ?>','<?php echo url('/super_updateTradeUserPassword'); ?>','760','580')">
                        重置交易密码
                    </button>
<button class="btn radius btn-primary size-S"
                            onclick="delMember(this,<?php echo htmlentities($u['id']); ?>,'<?php echo htmlentities($u['yuan_name']); ?>',1)">
                        删除用户
                    </button>
                </td>
            </tr>
...
<script type="text/javascript">
    ...
    function changeUserLanguage(obj, id, name, act) {
        if (act == 0) {
            var m = '您确定要更改用户<span style="color: red">' + name + '</span>语言为英语吗？';
            var btn = '确定';
            var su = '用户<span style="color: red">' + name + '</span>语言已经成功更改为英语';
        } else {
            var m = '您确定更改用户<span style="color: red">' + name + '</span>语言为中文吗？';
            var btn = '确定';
            var su = '用户<span style="color: red">' + name + '</span>语言已经成功更改为中文';
        }
        layer.confirm(m, {
            title: '请您确认',
            btn: [btn, '取消'],
            ...
            $.ajax({
                type: 'post',
                url: "<?php echo url('/super_changeUserLanguage'); ?>",
                data: {
                    id: id,
                    act: act
                },
                success: function (data) {
                    if (data.status) {
                        layer.msg(su, {time: 1500, icon: 1});
                        if (act == 0) {
                            $(obj).parent().html('<span class="label label-disabled radius" onclick="changeUserLanguage(this,' + id + ',\'' + name + '\',0)" style="cursor: pointer;">英语</span>')
                        } else {
                            $(obj).parent().html('<span class="label label-success radius" onclick="changeUserLanguage(this,' + id + ',\'' + name + '\',1)" style="cursor: pointer;">中文</span>')
                        }
                    } else {
                        layer.alert(data.msg);
                    }
    ...
    function changeUserFanyi(obj, id, name, act) {
        if (act == 0) {
            var m = '您确定要禁止用户<span style="color: red">' + name + '</span>翻译功能吗？';
            var btn = '禁止';
            var su = '用户<span style="color: red">' + name + '</span>已经成功被禁止翻译功能';
        } else {
            var m = '您确定把用户<span style="color: red">' + name + '</span>的翻译功能状态改为正常吗？';
            var btn = '恢复';
            var su = '用户<span style="color: red">' + name + '</span>的翻译功能状态已经成功恢复为正常';
        }
        layer.confirm(m, {
            title: '请您确认',
            btn: [btn, '取消'],
            ...
            $.ajax({
                type: 'post',
                url: "<?php echo url('/super_changeUserFanyi'); ?>",
                data: {
                    id: id,
                    act: act
                },
                success: function (data) {
                    if (data.status) {
                        layer.msg(su, {time: 1500, icon: 1});
                        if (act == 0) {
                            $(obj).parent().html('<span class="label label-disabled radius" onclick="changeUserFanyi(this,' + id + ',\'' + name + '\',0)" style="cursor: pointer;">禁用</span>')
                        } else {
                            $(obj).parent().html('<span class="label label-success radius" onclick="changeUserFanyi(this,' + id + ',\'' + name + '\',1)" style="cursor: pointer;">正常</span>')
                        }
                    } else {
                        layer.alert(data.msg);
                    }
...
function delMember(obj, id, name, act) {
        if (act == 1) {
            var m = '您确定要删除用户<span style="color: red">' + name + '</span>吗？';
            var btn = '删除';
            var su = '用户<span style="color: red">' + name + '</span>已经成功被删除';
        }
        layer.confirm(m, {
            title: '请您确认',
            btn: [btn, '取消'],
            ...
            $.ajax({
                type: 'post',
                url: "<?php echo url('/super_delMember'); ?>",
                data: {
                    id: id,
                    act: act
                },
                ...
                layer.msg('删除成功！');  
                $(obj).next().click(); 
                setTimeout("window.location.href = '<?php echo url('/super_memberList'); ?>'",600);
