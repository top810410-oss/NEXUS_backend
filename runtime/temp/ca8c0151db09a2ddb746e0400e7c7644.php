...
<script type="text/javascript">
    layList.form.render();
    layList.tableList('contactList',"<?php echo Url('/super_finance'); ?>",function () {
        return [
