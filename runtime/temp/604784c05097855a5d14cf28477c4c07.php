<?php /*a:1:{s:71:"/home/wwwroot/demo70.zhigou888.com/app/super/view/login/login_page.html";i:1764755762;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    function loginAction()
    {
        ...
        $.ajax({
            type:'post',
            url:"<?php echo url('/superloginAction'); ?>",
            data:{
            ...
            success:function (data) {
                ...
                if(data.status)
                {
                    ...
                    setTimeout(function () {
                        window.location.href = "<?php echo url('/admin_index'); ?>"
                    },2000);
                }
                else
                {
