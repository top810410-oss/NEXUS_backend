<?php /*a:1:{s:84:"/www/wwwroot/012.demo.zhigou888.cn/app/super/view/pollingkefu/polling_kefu_list.html";i:1764755762;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
   ...
   <td><?php echo htmlentities($u['pollingkefuid']); ?></td>
                ...
                <td>
                    <?php if($u['pollingkefu_term'] != ''): ?>
                    <u style="cursor:pointer" class="text-primary"
                       onclick="modaldemoterm('修改<?php echo htmlentities($u['nickname']); ?>的客服术语','<?php echo htmlentities($u['pollingkefu_term']); ?>','<?php echo htmlentities($u['id']); ?>')"><?php echo $u['pollingkefu_term']; ?>
                    </u>
                    <?php else: ?>
                    <!--<u style="cursor:pointer" class="text-primary"-->
                    <!--   onclick="modaldemoterm('修改<?php echo htmlentities($u['nickname']); ?>的客服术语','<?php echo htmlentities($u['pollingkefu_term']); ?>','<?php echo htmlentities($u['id']); ?>')">添加-->
                    <!--</u>-->
                    <span class="label label-success radius" onclick="modaldemoterm('修改<?php echo htmlentities($u['nickname']); ?>的客服术语','<?php echo htmlentities($u['pollingkefu_term']); ?>','<?php echo htmlentities($u['id']); ?>')"
                ...
                <td>
                    ...
                    <button class="btn radius btn-primary size-S"
                            onclick="edit(this,'<?php echo htmlentities($u['id']); ?>')">
                        设置轮询ID
                    </button>
                </td>
            </tr>
...
<!-- 编辑-->
     <div id="modal-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content radius">
                <div class="modal-header">
                    <h3 class="modal-title">设置客服轮询Id</h3> 
                    <a class="close" data-dismiss="modal" aria-hidden="true" href="javascript:void();">×</a>
                </div>
                <form method="POST" id="formEdit"  class="form form-horizontal">
                <div class="modal-body">
                   <div class="row cl">
                       <label class="form-label col-xs-4 col-sm-3" style="display:none;">客服id：</label>
						<div class="formControls col-xs-8 col-sm-9" style="display:none;">
							<input type="text" maxlength="4" class="input-text radius"  id="kefuid"  name="user_id" autocomplete="off"
                              onkeyup="value=value.replace(/[^\d]/g,'')"
                              placeholder="请输入客服轮询Id (纯数字)">
						</div>
						
						<label class="form-label col-xs-4 col-sm-3">轮询Id：</label>
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" maxlength="4" class="input-text radius"  id="pollingkefuid"  name="pollingkefuid" autocomplete="off"
                ...
                <div class="modal-footer">
                    <button type="button" onClick="updateKefuId(this);" class="btn btn-primary radius">确定</button>
                    <button type="rest" class="btn radius" data-dismiss="modal" aria-hidden="true">关闭</button>
                </div>
                </form>
            </div>
