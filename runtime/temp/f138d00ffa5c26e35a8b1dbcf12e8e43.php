<?php /*a:1:{s:66:"/www/wwwroot/012.demo.zhigou888.cn/app/super/view/admin/index.html";i:1764755762;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form method="get" action="<?php echo url('/super_adminList'); ?>">
        ...
        <div class="text-l"><!--  日期范围：
            ...
            --><input type="text" class="input-text" style="width:250px" placeholder="请输入管理员账户" id="" name="key" value="<?php if(isset($key['key'])): ?><?php echo htmlentities($key['key']); ?><?php endif; ?>">
       ...
       <p> 
        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td><u style="cursor:pointer" class="text-primary" ><?php echo $u['username']; ?></u></td>
                <td><?php echo $u['phone']; ?></td>
               <td><?php echo $u['email']; ?></td>
                <td><?php echo date('Y-m-d H:i:s',$u['create_time']); ?></td>
               
               <td>
                   <button class="btn radius btn-primary size-S" onclick="member_showChat('的会话','<?php echo htmlentities($u['id']); ?>','<?php echo url('/super_MemberChatList'); ?>','760','580')">查看会话</button> 
                   <button class="btn radius btn-primary size-S" onclick="member_showMail('的通讯录','<?php echo htmlentities($u['id']); ?>','<?php echo url('/super_MemberMailList'); ?>','760','580')">查看通讯录</button> 
    ...
    <div class="mt-15">
        <?php echo $adminlist->appends($key)->render(); ?>
    </div>
