<?php /*a:1:{s:71:"/home/wwwroot/demo70.zhigou888.com/app/super/view/login/changepass.html";i:1764755762;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
                   ...
                   <div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text radius" 
                              ...
                              value="<?php echo htmlentities($super_name); ?>" readOnly
                              placeholder="管理员名称">
                              <input type="hidden" class="input-text radius" 
                              id="super_id" name="super_id" autocomplete="off" 
                              value="<?php echo htmlentities($super_id); ?>"/>
						</div>
					</div>
...
function submitSave(){
  ...
  $.ajax({
        url: "<?php echo url('/super_updatepass'); ?>",
        type: 'POST',
        data: data,
        async: false,      
        success: function (data) {
            if(data.err == 0){
                layer.msg('提交成功！'); 
                window.parent.location.href = "<?php echo url('/admin_login'); ?>";
            }else{
                layer.msg(data.msg);
            }
        },
